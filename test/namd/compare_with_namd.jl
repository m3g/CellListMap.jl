...
function test_newcl(file,unit_cell,correct)
    coordinates = getcoor(file)
    box = Box(unit_cell, 10.)
...
@testset "NAMD" begin
  ...
  @test test_newcl("$dir/o1.dcd", unit_cell, correct)
  
  unit_cell = [ 80.,  70.,  50. ]
  correct = 1093.7225407797744
  @test test_newcl("$dir/o2.dcd", unit_cell, correct)
  ...
  @test test_newcl("$dir/o3.dcd", unit_cell, correct)
  
  unit_cell= transpose([ 70.7107   0.0      0.0
                         35.3553  61.2372   0.0
                         35.3553  20.4124  57.735 ])
  correct = 1754.0802503953591
  @test test_newcl("$dir/o4.dcd", unit_cell, correct)
  
  unit_cell= transpose([ 70.7107   0.0      0.0
                         35.3553  61.2372   0.0
                         35.3553  20.4124  57.735 ])
  correct = 1765.1389457850137
  @test test_newcl("$dir/o5.dcd", unit_cell, correct)
  
  unit_cell = [ 80.,  80., 80. ]
  correct = -158.04751357760088
  @test test_newcl("$dir/o6.dcd", unit_cell, correct)
  ...
  @test test_newcl("$dir/t1.dcd", unit_cell, correct)
  
  unit_cell = [ 50.      0.      0.
                50.     50.      0. 
                0.     50.     50. ]
  correct = 32096.48839031735
  @test test_newcl("$dir/t2.dcd", unit_cell, correct)
